module.exports = class{
    ...
    pushData(timestamp, indicatorValues, value, predictions){
        this.history.push({timestamp:timestamp, indicators:indicatorValues, value:value, predictions:predictions});
    }
    ...
    resolve(){
        while(this.history.length > 0)
        {
            ...
            if(foundIndex != undefined && foundIndex + 1 < this.history.length) //Is there also newer values?
            {
                ...
                //result, this.history[0].timestamp this.history[0].predictions TODO
